        ...
        <aside id="aside">
            ...
            <div class="petiteBarreDuHaut d-flex">
                ...
                <div class="dropdown">
                    ...
                    <div class="contenuDropdown">
                        <a href="#">
                            <!-- Icone "créer une communauté" -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="26.954" height="14.601" viewBox="0 0 26.954 14.601">
                                <path id="Icon_material-group-add" data-name="Icon material-group-add" d="M8.985,13.115H5.615V9.746H3.369v3.369H0v2.246H3.369v3.369H5.615V15.362H8.985Zm11.231,1.123a3.369,3.369,0,1,0-1.022-6.581A5.542,5.542,0,0,1,20.2,10.869a5.651,5.651,0,0,1-1.011,3.212A3.358,3.358,0,0,0,20.216,14.239Zm-5.615,0a3.369,3.369,0,1,0-3.369-3.369A3.355,3.355,0,0,0,14.6,14.239Zm7.435,2.426a4.155,4.155,0,0,1,1.55,3.19V22.1h3.369V19.854C26.954,18.124,24.292,17.057,22.035,16.664Zm-7.435-.18c-2.246,0-6.739,1.123-6.739,3.369V22.1H21.339V19.854C21.339,17.608,16.846,16.485,14.6,16.485Z" transform="translate(0 -7.5)" fill="#95509b" />
                            </svg>
                            Créer une communauté
                        </a>

                        <a href="?section=editerProfil">
                            <!-- Icone "Modifier profil" -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <path id="Union_63" data-name="Union 63" d="M0,16V14c0-2.2,3.6-4,8-4s8,1.8,8,4v2ZM4,4A4,4,0,1,1,8,8,4,4,0,0,1,4,4Z" fill="#95509b" />
                            </svg>
                            Modifier le profil
                        </a>

                        <a href="#">
                            <!-- Icone "Paramètres du compte" -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16.977" height="17.92" viewBox="0 0 16.977 17.92">
                                <path id="_Color" data-name=" ↳Color" d="M10.234,17.92H6.742a.447.447,0,0,1-.437-.381l-.327-2.375A6.331,6.331,0,0,1,4.5,14.291l-2.172.9a.466.466,0,0,1-.151.025.429.429,0,0,1-.383-.227l-1.747-3.1a.471.471,0,0,1,.11-.571L2.005,9.834A5.822,5.822,0,0,1,1.94,8.96a5.715,5.715,0,0,1,.076-.874L.172,6.608a.441.441,0,0,1-.109-.571l1.746-3.1A.433.433,0,0,1,2.188,2.7a.418.418,0,0,1,.155.03l2.172.9a6.54,6.54,0,0,1,1.473-.874L6.317.381A.429.429,0,0,1,6.742,0h3.492a.44.44,0,0,1,.437.381L11,2.755a6.362,6.362,0,0,1,1.473.874l2.172-.9a.466.466,0,0,1,.151-.025.429.429,0,0,1,.383.227l1.747,3.1a.471.471,0,0,1-.11.571L14.971,8.087a5.724,5.724,0,0,1,.065.874,7.5,7.5,0,0,1-.055.874L16.8,11.312a.441.441,0,0,1,.109.571l-1.746,3.1a.433.433,0,0,1-.379.231.419.419,0,0,1-.155-.03l-2.172-.9a6.478,6.478,0,0,1-1.473.874l-.327,2.375A.418.418,0,0,1,10.234,17.92ZM8.488,5.6a3.361,3.361,0,0,0,0,6.72,3.361,3.361,0,0,0,0-6.72Z" transform="translate(0)" fill="#95509b" />
                            </svg>
                            Paramètres du compte
                        </a>
                        <a href="#">
                            <!-- Icone Dark Mode (Lune) -->
                        ...
                        <a href="?section=deconnexion" class="" id="deconnexion">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="12.954" height="14.829" viewBox="0 0 12.954 14.829">
                                <path id="Tracé_1143" data-name="Tracé 1143" d="M1.534,1.534V13.295H8.863v1.534H0V0H8.863V1.534ZM8.352,12.272,7.159,11.079,9.886,8.352H3.579v-1.7h6.477L7.159,3.92,8.352,2.727l4.6,4.6Z" fill="#95509b" />
                            </svg>
                            Se déconnecter
                        </a>
                    </div>
            ...
            <!-- fin de la div du haut (3 div sous-menu aside) -->

            <!-- Premier panneau: Profil -->
            <div id="profil">
                <!-- Le pseudo -->
                <h2 class="violet nom"><?= $_SESSION['pseudo']; ?></h2>

                <!-- La photo de profil grande -->
                <div class="photoProfilGrande">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="99" height="102.001" viewBox="0 0 99 102.001">
                        <defs>
                            <pattern id="pattern" preserveAspectRatio="xMidYMid slice" width="100%" height="100%" viewBox="0 0 128 128">
                                <image width="128" height="128" xlink:href="data:image/jpeg;base64," />
                            </pattern>
                        ...
                        <g id="Groupe_1746" data-name="Groupe 1746" transform="translate(0 0.043)">
                            <g id="Groupe_1530" data-name="Groupe 1530" transform="translate(0 -0.043)">
                                <g id="Ellipse_287" data-name="Ellipse 287" transform="translate(0 0)" stroke="#707070" stroke-width="1" fill="url(#pattern)">
                                    <circle cx="49.5" cy="49.5" r="49.5" stroke="none" />
                                    <circle cx="49.5" cy="49.5" r="49" fill="none" />
                                </g>
                                <g id="Groupe_1529" data-name="Groupe 1529">
                                    <circle id="Ellipse_289" data-name="Ellipse 289" cx="49.5" cy="49.5" r="49.5" transform="translate(0 0)" fill="#fff" opacity="0.43" />
                                </g>
                            </g>
                            <g id="Groupe_1534" data-name="Groupe 1534" transform="translate(61.524 80.099)">
                                <circle id="Ellipse_290" data-name="Ellipse 290" cx="11" cy="11" r="11" transform="translate(0.477 -0.142)" fill="#f1f1f1" opacity="0.73" />
                                <g id="CAMERA" transform="translate(4.477 4.858)" clip-path="url(#clip-path)">
                                    <rect id="Rectangle_252" data-name="Rectangle 252" width="12" height="12" transform="translate(0 0)" fill="none" />
                                    <path id="Tracé_110" data-name="Tracé 110" d="M6.038,7.547a1.509,1.509,0,1,0-1.509-1.51A1.514,1.514,0,0,0,6.038,7.547Zm0-4.528A3.019,3.019,0,1,1,3.019,6.038,3.028,3.028,0,0,1,6.038,3.019Zm4.528,8.3H1.509a1.49,1.49,0,0,1-1.057-.453A1.49,1.49,0,0,1,0,9.812V3.019A1.514,1.514,0,0,1,1.509,1.509H2.717L3.849.377A1.25,1.25,0,0,1,4.755,0H7.4a1.212,1.212,0,0,1,.83.377L9.359,1.509h1.208a1.514,1.514,0,0,1,1.51,1.509V9.812A1.514,1.514,0,0,1,10.566,11.321Z" transform="translate(0 0.755)" fill="#3f50a7" fill-rule="evenodd" />
                                </g>
                            </g>
                        </g>
                    </svg>
                ...
                <div class="filActualite">
                    ...
                    <div class="contentActualite">
                        ...
                        <div>
                            <div>
                                <p class="bleu">Nouveau lieu !</p>
                                <p class="pt-2 pb-2 pl-2 bgJaune categorieNewLieu"><i class="fas fa-utensils"></i>Catégorie Restaurant</p>
                            </div>
                            <!-- Lieu ami (Le Damoiselle: texte + image) -->
                            ...
                            <div class="lieuAmi d-flex align-items-center justify-content-between ">
                                ...
                                <div class="lieuAmiTexte">
                                    <span>Rue de Lombardie 28, Saint-Gilles </span>
                                    <p>Le Damoiselle</p>
                                </div>
                            ...
                            <div class="mt-3">
                                <img src="public/images/imagesDemoCarte/le-damoiselle.jpg" alt="Goupil Le Fol">
                            </div>
                            <p>Aimé par...</p>
                        ...
                        <div>
                            <div>
                                <p class="bleu">Nouveau lieu !</p>
                                <p class="pt-2 pb-2 pl-2 bgViolet categorieNewLieu"><i class="fas fa-utensils"></i>Catégorie Bar</p>
                            </div>
                            <!-- Lieu ami (WoodCutter: texte + image) -->
                            ...
                            <div class="lieuAmi d-flex align-items-center justify-content-between ">
                                ...
                                <div class="lieuAmiTexte">
                                    <span>37 Rue des Alexiens, 1000 Bruxelles </span>
                                    <p>WoodCutter</p>
                                </div>
                                <div class="svgCoeur"><svg id="Groupe_1569" data-name="Groupe 1569" xmlns="http://www.w3.org/2000/svg" width="23.394" height="23.42" viewBox="0 0 23.394 23.42">
                                        <path id="Tracé_1110" data-name="Tracé 1110" d="M325.8,305.469h.068c.023.041.059,0,.086.027a5.118,5.118,0,0,1,2.109.618,7.11,7.11,0,0,1,3.587,5.528,3.737,3.737,0,0,0,.068.5v1.146a1.966,1.966,0,0,0-.064.455,7.46,7.46,0,0,1-1.777,4.064c-3.246,3.682-6.514,7.342-9.769,11.01-.068.077-.1.077-.173,0l-8.387-9.478c-.3-.336-.568-.7-.887-1a7.592,7.592,0,0,1-2.273-4.573,2.955,2.955,0,0,0-.064-.491v-1.146a.663.663,0,0,0,.041-.268,7.505,7.505,0,0,1,2.114-4.623,5.661,5.661,0,0,1,3.228-1.687,2.658,2.658,0,0,0,.455-.073h.1a.86.86,0,0,0,.455,0h.073c0,.032.036,0,.059,0a4.791,4.791,0,0,1,2.1.682,7.683,7.683,0,0,1,3,3.473c.023.041.032.1.082.132l.059-.136a8.337,8.337,0,0,1,1.9-2.65,5.456,5.456,0,0,1,2.841-1.459,1.667,1.667,0,0,0,.4-.064h.023A1.181,1.181,0,0,0,325.8,305.469Z" transform="translate(-308.33 -305.46)" fill="#3f50a7" />
                            ...
                            <div class="mt-3">
                                <img src="public/images/imagesDemoCarte/wood-cutter.jpg" alt="WoodCutter">
                            </div>
                            <p>Aimé par...</p>
                        ...
                        <div>
                            <div>
                                <p class="bleu">Nouveau lieu !</p>
                                <p class="pt-2 pb-2 pl-2 categorieNewLieu"><i class="fas fa-utensils"></i>Catégorie Autres</p>
                            </div>
                            <!-- Lieu ami (Le marché de la place du Jeu de Balle: texte + image) -->
                            ...
                            <div class="lieuAmi d-flex align-items-center justify-content-between ">
                                ...
                                <div class="lieuAmiTexte">
                                    <span>Place du Jeu de Balle
                                        1000 Bruxelles </span>
                                    <p>Le Marché du Jeu de Balle</p>
                                </div>
                                <div class="svgCoeur"><svg id="Groupe_1569" data-name="Groupe 1569" xmlns="http://www.w3.org/2000/svg" width="23.394" height="23.42" viewBox="0 0 23.394 23.42">
                                        <path id="Tracé_1110" data-name="Tracé 1110" d="M325.8,305.469h.068c.023.041.059,0,.086.027a5.118,5.118,0,0,1,2.109.618,7.11,7.11,0,0,1,3.587,5.528,3.737,3.737,0,0,0,.068.5v1.146a1.966,1.966,0,0,0-.064.455,7.46,7.46,0,0,1-1.777,4.064c-3.246,3.682-6.514,7.342-9.769,11.01-.068.077-.1.077-.173,0l-8.387-9.478c-.3-.336-.568-.7-.887-1a7.592,7.592,0,0,1-2.273-4.573,2.955,2.955,0,0,0-.064-.491v-1.146a.663.663,0,0,0,.041-.268,7.505,7.505,0,0,1,2.114-4.623,5.661,5.661,0,0,1,3.228-1.687,2.658,2.658,0,0,0,.455-.073h.1a.86.86,0,0,0,.455,0h.073c0,.032.036,0,.059,0a4.791,4.791,0,0,1,2.1.682,7.683,7.683,0,0,1,3,3.473c.023.041.032.1.082.132l.059-.136a8.337,8.337,0,0,1,1.9-2.65,5.456,5.456,0,0,1,2.841-1.459,1.667,1.667,0,0,0,.4-.064h.023A1.181,1.181,0,0,0,325.8,305.469Z" transform="translate(-308.33 -305.46)" fill="#3f50a7" />
                                    </svg>
                            ...
                            <div class="mt-3">
                                <img src="public/images/imagesDemoCarte/jeu-de-balle.jpg" alt="Goupil Le Fol">
                            </div>
                            <p>Aimé par...</p>
                                    ...
                                    <div class=" row">
                                        ...
                                        <div class="d-flex">
                                            <div class="d-flex ">
                                                ...
                                                <!-- Smiley icon -->
                                                <div class="pb-0 pt-0 pr-0 pl-2  align-self-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="33" height="20" viewBox="0 0 33 33">
                                                        <g id="Icon_feather-smile" data-name="Icon feather-smile" transform="translate(-1.5 -1.5)">
                                                            <path id="Tracé_1142" data-name="Tracé 1142" d="M33,18A15,15,0,1,1,18,3,15,15,0,0,1,33,18Z" fill="none" stroke="#3f50a7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" />
                                                            <path id="Tracé_1143" data-name="Tracé 1143" d="M12,21a8.1,8.1,0,0,0,6,3,8.1,8.1,0,0,0,6-3" fill="none" stroke="#3f50a7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" />
                                                            <path id="Tracé_1144" data-name="Tracé 1144" d="M13.5,13.5h.015" fill="none" stroke="#3f50a7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" />
                                                            <path id="Tracé_1145" data-name="Tracé 1145" d="M22.5,13.5h.015" fill="none" stroke="#3f50a7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" />
                                                        </g>
                                                    </svg>
                                                </div>
                                                <!-- Trombone icon -->
                                                ...
                                                <div>
                                                    <input type="text" name="newCommentaire" placeholder="Taper un message">
                                                </div>
