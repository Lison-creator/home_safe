...
<section class="container-flex imageDeFond">
    ...
    <div class="row"> <!-- composée de 2 colls -->
        ...
        <div class="col-6"><!-- Deuxième col qui prend l'autre moitié de la page pour le logo qui doit être centré -->
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 246 378.402" class="logoConnection">
                <g id="Logo_noir" data-name="Logo noir" opacity="0.64">
