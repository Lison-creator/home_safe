...
<div class="imageDeFond">
    <div class="col-12 barreHaut"> <!-- Barre noire en haut avec le logo + titre de la page -->
        <img src="" alt="logo">
    ...
    <div class="container-fluid"> <!-- Container avec tout le contenu -->
        <div class="row align-items-center">
            ...
            <section class="col-8 offset-left-1 questionMonProfil hidden"> <!-- Textes: Questions avec les réponses, par catégorie : Mon Profil -->
                <article>
            ...
            <section class="col-8 offset-left-1 questionMaCommunaute hidden"> <!-- Textes: Questions avec les réponses, par catégorie: Ma communauté -->
                <article>
            ...
            <section class="col-8 offset-left-1 questionBarSafe hidden"> <!-- Textes: Questions avec les réponses, par catégorie: Bars -->
                <article>
            ...
            <section class="col-8 offset-left-1 questionBarSafe hidden"> <!-- Textes: Questions avec les réponses, par catégorie: Rues -->
                <article>
